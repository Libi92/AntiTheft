...
<title>purplebiz - Free CSS Template by ZyPOP</title>
...
<div id="container" class="width">
	...
	<div class="width">
    		...
    		<h1><a href="/">purple<strong>biz</strong></a></h1>
	...
	<div class="width">
		...
		<div class="intro-content">
			...
			<p><a href="#" class="button button-slider"><i class="fa fa-gbp"></i> Download</a>
    ...
    <div id="body" class="width">
	    ...
	    <article>
			...
			<h2>Introduction to purplebiz</h2>
			<div class="article-info">Posted on <time datetime="2013-05-14">14 May</time> by <a href="#" rel="author">Joe Bloggs</a></div>

            <p>Welcome to purplebiz, a free valid CSS3 &amp; HTML5 responsive web template from . This template is completely <strong>free</strong> to use permitting a link remains back to </p>
...
<p> Should you wish to use this template unbranded you can buy a template license from our website for 8.00 GBP, this will allow you remove all branding related to our site, for more information about this see below.</p>	
		...
		<p>The image in the header is in the public domain, downloaded from</p>
    ...
    <tr ><td>
     Username:</td><td><input name="username" type="text" id="uname" value="" height="25px"></td></tr>
       ...
       <tr><td></td><td>
      <a href="" class="button" value="submit" onclick="login()">Login </a> 
      <a href="" class="button button-reversed" value="submit" onclick="login()"> forget password </a>
    </td></tr></table>
    <form>
